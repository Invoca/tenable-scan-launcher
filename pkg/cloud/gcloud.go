...
func GetGCloudIPs() {
	...
	//instances := computeService.Instances.Get("***REMOVED***", "*", "*")


	listRegions := computeService.Zones.List("***REMOVED***")
	...
	for _, region := range regions.Items {
		...
		listInstances := computeService.Instances.List("***REMOVED***", regionName)
